            ...
            <div className="relative">
              <div className="p-6 bg-white/10 backdrop-blur-md rounded-2xl shadow-lg border border-white/20">
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-white/10 rounded-lg shadow-sm border border-white/10 transform rotate-1 hover:-rotate-1 transition-transform">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-light text-black">Mario Rodríguez</div>
                  ...
                  <div className="p-4 bg-white/10 rounded-lg shadow-sm border border-white/10 transform -rotate-1 hover:rotate-1 transition-transform">
                    <div className="flex items-start gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-yellow-400 via-orange-500 to-blue-600 flex-shrink-0 flex items-center justify-center text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <div>
                        <div className="font-light text-black">Laura Sánchez</div>
                        <div className="mt-2 text-sm text-blue-100">
                  ...
                  <div className="p-4 bg-white/10 rounded-lg shadow-sm border border-white/10 transform rotate-2 hover:-rotate-2 transition-transform">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-light text-black">Javier García • Director de Marketing</div>
                        <div className="mt-2 text-sm text-blue-100">
                ...
                <div className="mt-4 text-center">
                  <div className="inline-block px-4 py-2 rounded-full bg-blue-700/30 text-blue-200 text-sm">
