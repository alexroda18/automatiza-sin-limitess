...
const Benefit: React.FC<BenefitProps> = ({ icon: Icon, title, delay }) => {
  return (
    ...
    >
      ...
      <p className="text-sm md:text-base text-black font-normal">{title}</p>
    </div>
  );
};
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-black font-normal opacity-0 animate-fadeIn animate-delay-100">
              ...
              <div className="opacity-0 animate-fadeIn animate-delay-500">
                <Button 
                  className="inline-flex items-center gap-2 px-10 py-5 bg-blue-100 text-blue-700 rounded-full transition-all hover:bg-blue-200 active:scale-[0.98] hover:-translate-y-0.5 border border-blue-200 font-montserrat uppercase text-base"
                >
                  Únete al grupo
                </Button>
              </div>
